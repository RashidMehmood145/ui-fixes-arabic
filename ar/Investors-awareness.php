					...
					<div class="row vertical-tabs careers-tabs">
						...
						<div  class="col-md-8 careers-category-col">
							<div class="tab-content">
								...
								<div class="tab-pane" id="Knowledge" role="tabpanel">
									<div class="row">
										<div  class="col-md-12">
											<div class="awareness-content-wrapper">
												<h3></h3>
												...
												<div class="abou-knowledge-table">
													<div class="speculation-investing-saving">
														<div class="td-row">
															...
															<div class="td-col2 account-type">Saving</div>
															<div class="td-col3 account-type">Investing</div>
															<div class="td-col4 account-type">Speculation</div>
														</div>
														<div class="td-row">
															<div class="td-col1 asset-type detail-term-type">Goals</div>
															<div class="td-col2 detail-term-type">Short-term: (3 years or less) For example: vacations, emergency money, car, etc.)</div>
															<div class="td-col3 detail-term-type">Long-term: (3 years or more) For example: retirement, buying a home, kids college education, etc.</div>
															<div class="td-col4 detail-term-type">Very short-term: (90 days or less) Buying and selling to achieve capital gain</div>
														</div>
														<div class="td-row">
															<div class="td-col1 asset-type detail-liquidity-type">Liquidity</div>
															<div class="td-col2 detail-liquidity-type">High</div>
															<div class="td-col3 detail-liquidity-type">Low</div>
															<div class="td-col4 detail-liquidity-type">High</div>
														</div>
														<div class="td-row">
															<div class="td-col1 asset-type detail-risk-type">Risk</div>
															<div class="td-col2 detail-risk-type">Low</div>
															<div class="td-col3 detail-risk-type">Medium – High</div>
															<div class="td-col4 detail-risk-type">Extremely High</div>
														  </div>
														<div class="td-row">
															<div class="td-col1 asset-type detail-return-type">Return</div>
															<div class="td-col2 detail-return-type">Interest</div>
															<div class="td-col3 detail-return-type">Interest, Profit, Capital gain</div>
															<div class="td-col4 detail-return-type">Capital gain</div>
														</div>
														<div class="td-row">
															<div class="td-col1 asset-type detail-asset-type">Asset Class</div>
															<div class="td-col2 detail-asset-type">Cash</div>
															<div class="td-col3 detail-asset-type">Equity, Fixed Income, Real Estate, etc.</div>
															<div class="td-col4 detail-asset-type">High volatile assets</div>
														</div>				  
													</div>												
												</div>
											...
											<div class="new-client-content-wrapper">
												<div class="accordion" id="accordion_faq_resource">
												  <div class="card">
													...
													<div id="collapse1" class="collapse show" aria-labelledby="heading1" data-parent="#accordion_faq_resource">
													  <div class="card-body">
												  ...
												  <div class="card">
													...
													<div id="collapse2" class="collapse" aria-labelledby="heading2" data-parent="#accordion_faq_resource">
														<div class="card-body">
															<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
												  ...
												  <div class="card">
													...
													<div id="collapse3" class="collapse" aria-labelledby="heading3" data-parent="#accordion_faq_resource">
													  <div class="card-body">
															<p>Once you have decided on your strategy for goals, the next action is to allocate your money into the asset classes that will help you achieve your goal.  The main 4 Asset Classes that you can invest in are:</p>
															<ol>
																<li>Cash or “Money Market”</li>
																<li>Fixed income “Bonds or Sukuks”</li>
																<li>Equities – Public Listed Companies or Private Companies</li>
																<li>Alternatives “Real Estate, etc.”</li>
															</ol>

															<p>Each Asset Class has different Risk and Return profiles.  Almost every investor should have at least 2 or 3 Asset Classes in his portfolio depending on its size. Every Asset Class should have at least 5 to 10 Securities.  For example, if you are investing in Equities, you should diversify your investment into at least 10 companies in different sectors and/or different markets (local, emerging, or developed)</p>
													  </div>
													</div>
												  </div>
												  <div class="card">
													...
													<div id="collapse4" class="collapse" aria-labelledby="heading4" data-parent="#accordion_faq_resource">
													  <div class="card-body">
															<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
												  ...
												  <div class="card">
													...
													<div id="collapse5" class="collapse" aria-labelledby="heading5" data-parent="#accordion_faq_resource">
													  <div class="card-body">
															<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
												  ...
												  <div class="card">
													...
													<div id="collapse6" class="collapse" aria-labelledby="heading6" data-parent="#accordion_faq_resource">
													  <div class="card-body">
															<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
								...
								<div class="tab-pane" id="CMA" role="tabpanel">
									<div class="row">
										<div  class="col-md-12">
											<div class="new-client-content-wrapper">
												<div class="accordion" id="accordion_faq_resource">
												  <div class="card">
													...
													<div id="collapse1" class="collapse show" aria-labelledby="heading1" data-parent="#accordion_faq_resource">
													  <div class="card-body">
															<p><a href="#" target="_blank" class="cma-files"><img src="./assets/images/pdf-icon.svg"> <b>CMA Awareness Instructions</b></a></p>

															<p><a href="#" target="_blank" class="cma-files"><img src="./assets/images/pdf-icon.svg"> <b>Objectives of Opening Saudi Stock Market for Foreign Investment</b></a></p>

															<p><a href="#" target="_blank" class="cma-files"><img src="./assets/images/pdf-icon.svg"> <b>Awareness Documents for AML/CTF</b></a></p>
													  </div>
													</div>
												  </div>
												  <div class="card">
													<div class="card-header" id="heading2">
													  <h2 class="mb-0">
														<button class="btn collapsed" type="button" data-toggle="collapse" data-target="#collapse2" aria-expanded="false" aria-controls="collapse2">
														 CMA’s Investor Awareness Guidebooks:
														</button>
													  </h2>
													</div>
													<div id="collapse2" class="collapse" aria-labelledby="heading2" data-parent="#accordion_faq_resource">
