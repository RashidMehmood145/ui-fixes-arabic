...
?>
		<main role="main">		
			...
			<section class="after-update-kyc-hero-section kyc-arabic">
						...
						<div class="content-outer-line-container">
							<div class="inner-col">
								<div class="row justify-content-center">
									<div class="col-lg-8">
										<div class="inner-col">
											<h2 class="form-company-title rtl">Alistithmar Capital</h2>
											<h3 class="KYC-Update-name rtl">Online <span>KYC Update</span></h3>
											<div class="KYC-Update-wrapper rtl">
												<div class="form-type-label rtl">Personal Information</div>													
													<form action="/action_page.php rtl">
														...
														<div class="form-group captcha-box rtl">
